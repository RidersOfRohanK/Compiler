...
class DeclListNode extends ASTnode {
    ...
    public List<DeclNode> getMyDeclNodes(){
        return this.myDecls;
    }
...
class BoolNode extends TypeNode {
    ...
    public void unparse(PrintWriter p, int indent) {p.print("boolean");
    }
}
...
class VoidNode extends TypeNode {
    ...
    public void unparse(PrintWriter p, int indent) {p.println("void");
    }
}
